const ListContact = () => {
    ...
    return (
        <div className="container grid grid-cols-1 md:grid-cols-3 md:max-w-screen-xl p-5 mx-auto mt-60">
            <div className="md:col-span-2">

                <hr className="my-6 sm:mx-auto border-stone-700 lg:my-8 mt-20" /><div>
                    <h1 className="font-normal text-xl md:mb-5">This is my Email</h1>
                    <a href="andi.suryakerja@gmail.com" className="mt-auto">@andi.suryakerja@gmail.com</a>
                </div>
                <hr className="my-6 sm:mx-auto border-stone-700 lg:my-8 mt-20" /><div>
                    <h1 className="font-normal text-xl md:mb-5">This is my Instagram</h1>
                    <a href="https://www.instagram.com/andiiiii.sp/" className="mt-auto">@andiiiii.sp</a>
                </div>
                <hr className="my-6 sm:mx-auto border-stone-700 lg:my-8 mt-20" /><div>
                    <h1 className="font-normal text-xl md:mb-5">This is my Github</h1>
                    <a href="https://github.com/Andisurya01" className="mt-auto">Andisurya01</a>
                </div>
                <hr className="my-6 sm:mx-auto border-stone-700 lg:my-8 mt-20" /><div>
                    <h1 className="font-normal text-xl md:mb-5">this is my LinkedIn</h1>
