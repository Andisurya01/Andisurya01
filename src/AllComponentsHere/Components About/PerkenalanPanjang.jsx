    ...
    return (
        <div className="container mx-auto mt-40 max-w-screen-xl grid grid-cols-1 md:grid-cols-3 " >
            <div className="mx-auto">
                ...
                <div className="max-w-screen-xl mx-auto h-1 lg:my-5">
                    <hr className="border-stone-700 " />
                </div>
            </div>
            <div className="mx-auto px-5" >
                <h1 className="font-bebas text-xl md:text-3xl">About Andi</h1>
                <ul className="font-montserrat lg:text-lg text-xs">
                    <li >
