...
const Navbar = () => {
    ...
    return (
        <nav className="bg-neutral-900 fixed w-full z-20 top-0 left-0 ">
            <div className=" flex flex-wrap relative md:max-w-screen-xl items-center justify-between mx-auto p-4">
                <div className="relative">
                    <a onClick={() => navigate("/")} className="">
                        <span className="self-center absolute font-bebas text-2xl whitespace-nowrap text-stone-100">ANDI SURYA PRIYADI</span>
                    </a>
                </div>
